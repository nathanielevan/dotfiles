# Generated by Powerlevel10k configuration wizard on 2021-01-10 at 15:24 WIB.
...
() {
  ...
  # Magenta previous command duration.
  ...
  # Remove all spaces, then change all colons to spaces.
