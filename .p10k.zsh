# Generated by Powerlevel10k configuration wizard on 2020-02-09 at 03:21 WIB.
...
() {
  ...
  function my_git_formatter() {
    ...
    local       meta='%B%234F' # black foreground
    local      clean='%B%234F' # black foreground
    local   modified='%B%234F' # black foreground
    local  untracked='%B%234F' # black foreground
    local conflicted='%B%234F' # black foreground
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  # typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=234
